...
def run_stage4_sft(model_type, tokenizer, base_dir, stage3_model_path):
    ...
    args = TrainingArguments(
        ...
        gradient_accumulation_steps=4, learning_rate=1.0e-4, logging_steps=1, save_steps=5,
...
def run_stage5_dpo(model_type, tokenizer, base_dir, stage4_model_path):
    ...
    args = DPOConfig(
        ...
        gradient_accumulation_steps=4, learning_rate=7.0e-8, lr_scheduler_type="linear", warmup_steps=1,
